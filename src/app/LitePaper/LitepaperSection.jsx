      ...
      >
        ...
        <div className="space-y-8 text-lg md:text-xl leading-loose">
          ...
          <section>
            ...
            <p className="pl-6">
              Most crypto tokens offer <span className="text-red-300">no immediate value</span> to holders unless traded or staked. Passive income in DeFi is often locked behind <span className="italic">complexity</span> or <span className="font-semibold">high fees</span>.
            </p>
            <p className="pl-12">
              PWINT solves this by making rewards <span className="text-green-300">effortless and automatic</span>—wealth creation, redefined.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="pl-6">PWINT delivers:</p>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 pl-12">
